...
namespace Notes2022.Server.Migrations
{
    ...
    [Migration("20220609192616_LoginLog")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Notes2022.Server.Data.JsonData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Notes2022.Server.Proto.ActiveUsers", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Notes2022.Server.Proto.LoginLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<DateTimeOffset?>("TheTime")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("Notes2022.Server.Proto.NoteAccess", b =>
                {
                    b.Property<string>("UserID")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Notes2022.Server.Proto.NoteContent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Notes2022.Server.Proto.NoteFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Notes2022.Server.Proto.NoteHeader", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Notes2022.Server.Proto.Sequencer", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Notes2022.Server.Proto.Tags", b =>
                {
            ...
            modelBuilder.Entity("Notes2022.Server.Proto.TalkLog", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Notes2022.Server.Proto.NoteAccess", b =>
                {
                    b.HasOne("Notes2022.Server.Proto.NoteFile", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Notes2022.Server.Proto.NoteContent", b =>
                {
                    b.HasOne("Notes2022.Server.Proto.NoteHeader", null)
                        .WithMany()
